...
@section('content')
    ...
    <section class="w-full grid grid-cols-10">
        <div
            ...
            <div class="mb-8 flex w-full max-w-[370px] relative">
                <div
                    class="bg-white text-white mr-6 flex h-[90px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[90px] sm:max-w-[90px]">
        ...
        <div class="col-span-10 md:col-span-6 px-6 py-16 md:p-20 bg-primary-50">
            ...
            <form action="{{ route('contact.message') }}" method="post">
               ...
               @error('nome') border-red-700 focus:border-red-600 focus:ring-red-700 @enderror
              ...
              "
                    ...
                    <div class="md:col-span-2 mb-2">
                        ...
                        <input type="text" name="contacto" id="contacto"
                            class="h-10 border mt-1 rounded-sm p-6 px-4 w-full
               ...
               "
                    ...
                    <div class="md:col-span-2 mb-2">
                        ...
                        <div class=" flex border border-primary-200  items-center mt-1">
                            <textarea name="mensagem" id="mensagem" cols="10" rows="5"
                                class=" px-4 appearance-none outline-none
                  ...
                  "
                    ...
                    <div class="md:col-span-2 text-right mb-2">
                        <div class="">
                            <button type="submit"
                                class="bg-primary-700 hover:ring-1 hover:ring-primary-500 text-white font-bold py-3 px-4 rounded-sm w-full">Enviar
                                mensagem</button>
                        </div>
                    </div>
                </div>
