...
<div class="h-96 ml-0">
    ...
    <iframe class="w-screen ml-0 h-full z-40" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2502.6800779306527!2d34.848408201747645!3d-19.830637859956976!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1f2a4148c3c9083b%3A0xd99f8fc7ab1f4b2c!2sSumburero%20Mo%C3%A7ambique!5e0!3m2!1sen!2smz!4v1695076814627!5m2!1sen!2smz" style="border: 0" allowfullscreen="true" loading="lazy" referrerpolicy="no-referrer-when-downgrade"> </iframe>
</div>
<section class="w-full grid grid-cols-10">
    <div class="hidden  relative col-span-10 md:col-span-4 md:grid transition-transform  p-20 text-white font-semibold ">
        <img class="absolute inset-0 w-full h-full object-cover" src="{{ Vite::asset('resources/images/hero.webp') }}" alt="mockup">
        <div class="absolute   inset-0 bg-black opacity-80"></div>

        <div class="mb-8 flex w-full max-w-[370px] relative">
            <div class=" bg-wh mr-6 flex h-[60px] bg-white w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-10 sm:h-[70px] sm:max-w-[70px]">
            ...
            <div class="w-full ">
                <h4 class="text-white mb-1 text-xl font-semibold uppercase">
                    Localização
                </h4>
        ...
        <div class="mb-8 flex w-full max-w-[370px] relative">
            <div class="bg-white text-white mr-6 flex h-[90px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[90px] sm:max-w-[90px]">
    ...
    <div class="col-span-10 md:col-span-6 px-6 py-16 md:p-20 bg-primary-50">
        @if (session('success'))
        ...
        @endif
        <form action="{{ route('contact.message') }}" method="post" name="contact_us">
            @csrf
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-2 justify-items-stretch">
                <div class="mb-2">
                    ...
                    <input type="text" name="nome" id="nome" class="h-10 border mt-1 focus:ring-1
               focus:ring-primary-700 border-zinc-700 focus:border-primary-600 rounded-sm p-6
               px-4 w-full bg-primary-50

               @error('nome') border-red-700 focus:border-red-600 focus:ring-red-700 @enderror" value="{{ old('nome') }}" placeholder="Nome" />
                    @error('nome')
                    <span class="text-red-500 text-sm font-normal ">{{ $message }}</span>
                    @enderror
                </div>
                <div class="mb-2">
                    <label for="email">E-mail <strong class="-order-2 text-red-500">*</strong></label>
                    <input type="text" name="email" id="email" class="h-10 border mt-1
               rounded-sm p-6 px-4 w-full bg-primary-50 focus:ring-1
              focus:ring-primary-700 border-zinc-700 focus:border-zinc-700

              @error('email') border-red-700 focus:border-red-600 focus:ring-red-700 @enderror
              " value="{{ old('email') }}" placeholder="Exemplo@sumburero.org" />
                    @error('email')
                    <span class="text-red-500 text-sm font-normal ">{{ $message }}</span>
                    @enderror
               ...
               bg-primary-50 focus:ring-1 border-zinc-700
               focus:ring-primary-700 focus:border-zinc-700
               @error('contacto') border-red-700 focus:border-red-600 focus:ring-red-700 @enderror
               " value="{{ old('contacto') }}" placeholder="Contacto" />
                ...
                <div class="md:col-span-2 mb-2">
                    <label for="mensagem">Mensagem <strong class="-order-2 text-red-500">*</strong></label>
                    <div class=" flex border border-primary-200  items-center mt-1">
                        <textarea name="mensagem" id="mensagem" cols="10" rows="5" class=" px-4 appearance-none outline-none
                  text-gray-800 w-full bg-transparent focus:ring-1 border-zinc-700
                  focus:ring-primary-700 focus:border-zinc-700 rounded-sm

                  @error('mensagem') border-red-700 focus:border-red-600 focus:ring-red-700 @enderror
                ...
                <div class="md:col-span-2 text-right mb-2">
                    <div class="">
                        <button type="submit" class="bg-primary-700 hover:ring-1 hover:ring-primary-500 text-white font-bold py-3 px-4 rounded-sm w-full">Enviar
                            mensagem</button>
                    </div>
                </div>
            </div>
