...
<section class="w-full grid grid-cols-10">
    <div
        class="hidden col-span-10 md:col-span-4 md:grid transition-transform bg-primary-500 p-20 text-white font-semibold"
    >
    ...
    <div class="col-span-10 md:col-span-6 px-6 py-16 md:p-20 bg-primary-50">
        ...
        <div id="alert-border-2" class="flex p-4 mb-4 text-primary-800 border-t-4 border-primary-300 bg-primary-50 dark:text-primary-400 dark:bg-gray-800 dark:border-primary-800" role="alert">
            <svg class="flex-shrink-0 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path>
            </svg>
            <div class="ml-3 text-sm font-medium">
        ...
        <form action="{{ route('contact.message') }}" method="post" name="contact_us">
            ...
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-2 justify-items-stretch">
                <div class="mb-2">
                    <label for="nome">Nome <strong class="-order-2 text-primary-500">*</strong></label>
               ...
               @error('nome') border-primary-700 focus:border-primary-600 focus:ring-primary-700 @enderror" value="{{ old('nome') }}" placeholder="Nome" />
                    @error('nome')
                    <span class="text-primary-500 text-sm font-normal ">{{ $message }}</span>
                    @enderror
                </div>
                <div class="mb-2">
                    <label for="email">E-mail <strong class="-order-2 text-primary-500">*</strong></label>
              ...
              @error('email') border-primary-700 focus:border-primary-600 focus:ring-primary-700 @enderror
              " value="{{ old('email') }}" placeholder="contacto@ampdc.org" />
                    @error('email')
                    <span class="text-primary-500 text-sm font-normal ">{{ $message }}</span>
                    @enderror
               ...
               @error('contacto') border-primary-700 focus:border-primary-600 focus:ring-primary-700 @enderror
               " value="{{ old('contacto') }}" placeholder="Contacto" />
                ...
                <div class="md:col-span-2 mb-2">
                    <label for="mensagem">Mensagem <strong class="-order-2 text-primary-500">*</strong></label>
                  ...
                  @error('mensagem') border-primary-700 focus:border-primary-600 focus:ring-primary-700 @enderror
                ...
                <div class="md:col-span-2 text-right mb-2">
                    <div class="">
                        <button type="submit" class="bg-primary-500 hover:ring-1 hover:ring-primary-500 text-white font-bold py-3 px-4 rounded-sm w-full">Enviar
                            mensagem</button>
                    </div>
                </div>
            </div>
