<section class="bg-gray-50">
    <div class="grid  px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-8 lg:px-32">

        <div class="flex flex-col mr-auto place-self-center  tracking-tight p-8 pb-0 text-gray-600 w-full">
            <h1 class="max-w-2xl mb-4  text-sm font-extrabold tracking-tight leading-none capitalize " data-aos="fade-up"
                data-aos-delay="5">— Eventos</h1>
            <h2 class="max-w-2xl mb-2 text-2xl font-semibold  tracking-tight leading-none
              capitalize "
                data-aos="fade-up" data-aos-delay="10">Próximos eventos.</h2>

            <div class=" grid  gap-4 py-6 w-full">
                @for ($i = 0; $i < 3; $i++)
                    <article
                        class="flex flex-row justify-start rounded-t w-full
                        ...
                        <div class="grid content-center mx-3 w-full">
                            <div class="inline-flex align-middle ">
                                <span class="inline-flex flex-row align-middle ">
                                    ...
                                    <span class="inline-flex flex-row align-middle text-sm">1:00 PM -
                                        7:00 PM</span>
                                </span>
                                <span class="inline-flex flex-row align-middle ">
                                    ...
                                    <span
                                        class="inline-flex flex-row align-middle text-sm  line-clamp-1">Beira,
                                        Matacuane, casa das Pizzas</span>
                                </span>
                            </div>
                            <div class="flex  justify-between my-1 w-full">
                                <h2
                                    class=" text-lg font-medium  line-clamp-1 capitalize mr-8 tracking-wide">
                                    Feira juvenil, Beira </h2>
                                <a href="#"
                                    class="flex min-w-fit flex-row self-center   font-medium text-center right-0 pr-4 text-sm ">
                                    Ler mais
