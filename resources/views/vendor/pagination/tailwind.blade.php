                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="relative inline-flex bg-primary-700 items-center px-4 py-2 -ml-px text-sm font-medium text-gray-50 border border-gray-300 cursor-default leading-5">{{ $page }}</span>
                                    </span>
                                @else
