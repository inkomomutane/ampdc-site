    ...
    public function handle()
    {
        ...
        try {
            Sitemap::create(config('app.url'))
                ->add(Url::create(route('welcome'))->addImage(Vite::asset('resources/js/images/logo.webp')))
                ->add(Url::create(route('contact'))->addImage(Vite::asset('resources/js/images/logo.webp')))
                ->add(Url::create(route('about.us'))->addImage(Vite::asset('resources/js/images/logo.webp')))
